...
<ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="index.php">Student</a> Manage student <i class="fa fa-cog">View student</i> 
                </ol>
               <div class="grid-form">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="<?php echo $row->firstname;?>">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Middle name</label>
    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="<?php echo $row->middlename;?>">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Last name</label>
    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="<?php echo $row->lastname;?>">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="<?php echo $row->phone;?>">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Admission date</label>
    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="<?php echo $row->admissiondate;?>">
  </div>
  </form>
  </div>
  </div>

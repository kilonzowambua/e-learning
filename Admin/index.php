							...
							<div class="profile_details_left"><!--notifications of menu start -->
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-envelope"></i><span class="badge">online</span></a>
									...
									<li class="dropdown head-dpdn">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-bell"></i><span class="badge blue">online</span></a>
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
									...
									<li class="dropdown head-dpdn">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-tasks"></i><span class="badge blue1">online</span></a>
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>Update profile if not done</h3>
												</div>
											</li>
											<!--<li><a href="#">
												<div class="task-info">
                                ...
                                <div class="card-body card-padding">
                                    <div class="widget">
                                        <header class="widget-header">
                                            <h4 class="widget-title">Factulties</h4>
                                        </header>
...
<div class="copyrights">
	 <p> All Rights Reserved | Design by Erick <a href="" target="_blank">E-learning system</a> </p>
</div>	
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.php"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
										 ...
										 <li id="menu-academico" ><a href="profile.php"><i class="fa fa-envelope nav_icon"></i><span>Profile</span><div class="clearfix"></div></a></li>
									<li><a href="gallery.html"><i class="fa fa-picture-o" aria-hidden="true"></i><span>List of students</span><div class="clearfix"></div></a></li>
									<li id="menu-academico" ><a href="charts.html"><i class="fa fa-bar-chart"></i><span>List of lecturers</span><div class="clearfix"></div></a></li>
									 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>List of Courses </span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="icons.html">Theology</a></li>
											<li id="menu-academico-avaliacoes" ><a href="typography.html">Busness</a></li>
											<li id="menu-academico-avaliacoes" ><a href="faq.html">Medicine</a></li>
										  </ul>
										</li>

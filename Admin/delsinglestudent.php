...
$stmt->execute();
echo"<script>alert('student Account  Has Been deleted Successfully');</script>";
}
?>
<?php	
	$id=$_GET['stdid'];
	...
	$stmt= $conn->prepare($ret) ;
	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Student</a> Manage student <i class="fa fa-cog">Delete student</i> 
                </ol>
  ...
  <div class="col-sm-6 col-sm-offset-4">
          <input type="submit" name="del" Value="del" class="btn btn-warning ">
          </div>
									</form>
  </form>
  </div>

...
$stmt=$conn->prepare("SELECT email,password,id FROM lec WHERE email=? and password=? ");
				...
				if($rs)
				{
					header("location:lec/lec-dashboard.php");
				}
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-4">Log in with Lecturers account</h2>

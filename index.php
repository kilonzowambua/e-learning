  ...
  <body>
    ...
    <header role="banner">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand absolute" href="index.php">E-learning system</a>
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            <ul class="navbar-nav mx-auto">
             ...
             <!-- <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Portals</a>
                <div class="dropdown-menu" aria-labelledby="dropdown05">
                  <a class="dropdown-item" href="login.php">Students</a>
                  <a class="dropdown-item" href="lecturerlogin.php">Lecturers</a>
            ...
            <div class="col-lg-3 hidden-md col-sm-6 hidden-xs pull-right">
              <a href="login.php" class="btn btn-outline head-btn">Students</a>
          
          <div class="col-lg-3 hidden-md col-sm-6 hidden-xs pull-right">
            <a href="lecturerlogin.php" class="btn btn-outline head-btn">Lecturers</a>
        
            <div class="col-lg-3 hidden-md col-sm-6 hidden-xs pull-right">
              <a href="adminlogin.php" class="btn btn-outline head-btn">Admin</a>
          </div>-->
        </div>
        </div>
          </div>

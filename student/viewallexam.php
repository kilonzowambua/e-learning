...
?>
                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            <li class="list-inline-item active">
                                                <a href="#">All assessment</a>
                                            </li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">Examination</li>
                                        </ul>
                                    </div>
            ...
            <div class="section__content section__content--p30">
                    <div class="container-fluid">
                    <h3 class="title-5 m-b-35">All EXAMINATION PAPERS</h3>
...
$Stdid=$_SESSION['stdid'];
                    ...
                    $ret="SELECT * FROM qns WHERE type='Exam paper'AND coursename='$coursename'";
                     $stmt= $conn->prepare($ret) ;
                    // $stmt->bind_param('i',$stdid);
                     $stmt->execute() ;//ok
                     $res=$stmt->get_result();
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="viewexam.php?id=<?php echo $row->id;?>">

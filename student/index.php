                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    ...
                                    <span class="desc">online book</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number">ksh 1,060</h2>
                                    <span class="desc">Course cost</span>
                                    <div class="icon">
                                        ...
                                        <form action="" method="post" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="username2" name="username2" placeholder="<?php echo $row->firstname;?> <?php echo $row->lastname;?>" class="form-control">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="username2" name="username2" placeholder="<?php echo $row->course;?>" class="form-control">
                                                    <div class="input-group-addon">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="email" id="email2" name="email2" placeholder="<?php echo $row->email;?>" class="form-control">
                                                    <div class="input-group-addon">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="username2" name="username2" placeholder="<?php echo $row->phone;?>" class="form-control">
                                                    <div class="input-group-addon">

	...
	<?php
						if(isset($_POST['register'])){
						  ...
						  $email = $_POST['email'];
							...
							$qry = "INSERT INTO user (email,password)
                ...
                <!--  <div class="row mb-5">
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <input type="submit" name="register" value="register" class="btn btn-primary px-5 py-2">
                    </div>
                  </div>
                </form>
              </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="" target="_blank" class="text-primary">E-learning system</p>
